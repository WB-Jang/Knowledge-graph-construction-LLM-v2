...
def export_all(document: LegalDocument, base_name: Optional[str] = None) -> str:
    ...
    export_nodes_csv(document.entities, os.path.join(out_dir, "nodes.csv"))
    export_triplets_csv(document.triplets, os.path.join(out_dir, "triplets.csv"))
    export_nodes_tsv(document.entities, os.path.join(out_dir, "nodes.tsv"))
    export_triplets_tsv(document.triplets, os.path.join(out_dir, "triplets.tsv"))
    export_summary_txt(document, os.path.join(out_dir, "summary.txt"))
